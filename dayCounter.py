# this is a simple Python program that counts how many days have elapsed since the beginning of the year, decade, century or  millennium 
# takes MM DD YYYY as input 
